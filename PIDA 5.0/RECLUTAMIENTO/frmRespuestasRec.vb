Public Class frmRespuestasRec
    ...
    Private Sub frmRespuestasRec_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            dtLista = sqlExecute("SELECT cod_respuesta as 'Código',Nombre,RTRIM(Estilo) AS Estilo FROM respuestas", "RECLUTAMIENTO")
            ...
            dtRegistro = sqlExecute("SELECT TOP 1 * FROM respuestas ORDER BY cod_respuesta ASC ", "RECLUTAMIENTO")
    ...
    Private Sub MostrarInformacion()
        ...
        Try
            ...
            ElseIf Estilo = "OPCION MULTIPLE" Then
                ...
                Next
                If IsDBNull(dtRegistro.Rows(0).Item("seleccion_multiple")) Then
                    chkUnaRespuesta.Checked = True
                    chkSeleccionMultiple.Checked = False
                Else
                    If dtRegistro.Rows(0).Item("seleccion_multiple").ToString.Trim = "0" Then
                        chkUnaRespuesta.Checked = True
                        chkSeleccionMultiple.Checked = False
                    Else
                        chkUnaRespuesta.Checked = False
                        chkSeleccionMultiple.Checked = True
                    End If
                End If
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Dim Cod As String
        Cod = Buscar("reclutamiento.dbo.respuestas", "cod_respuesta", "respuestas", False)
        If Cod <> "CANCELAR" Then
            dtRegistro = sqlExecute("SELECT * from respuestas WHERE cod_respuesta = '" & Cod & "'", "RECLUTAMIENTO")
            MostrarInformacion()
        End If
    End Sub

    Private Sub btnPrimero_Click(sender As Object, e As EventArgs) Handles btnPrimero.Click
        Primero("respuestas", "cod_respuesta", dtRegistro, "RECLUTAMIENTO")
        MostrarInformacion()
    End Sub

    Private Sub btnSiguiente_Click(sender As Object, e As EventArgs) Handles btnSiguiente.Click
        Siguiente("respuestas", "cod_respuesta", txtCodigo.Text, dtRegistro, "RECLUTAMIENTO")
        MostrarInformacion()
    End Sub
    ...
    Private Sub btnBorrar_Click(sender As Object, e As EventArgs) Handles btnBorrar.Click
        ...
        Try
            ...
            dtTemporal = sqlExecute("SELECT cod_respuesta FROM preguntas WHERE cod_respuesta = '" & codigo & "'", "RECLUTAMIENTO")
            ...
            Else
                If MessageBox.Show("¿Está seguro de borrar el registro " & codigo & "?", "Borrar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                    sqlExecute("DELETE FROM respuestas WHERE cod_respuesta = '" & codigo & "'", "RECLUTAMIENTO")
    ...
    Private Sub dgTabla_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles dgTabla.RowEnter
        Try
            ...
            dtRegistro = sqlExecute("SELECT * from respuestas WHERE cod_respuesta = '" & cod & "' AND nombre = '" & nom & "'", "RECLUTAMIENTO")
            MostrarInformacion()
        Catch ex As Exception
            ErrorLog(Usuario, System.Reflection.MethodBase.GetCurrentMethod.Name(), Me.Name, ex.HResult, ex.Message)
        End Try
    ...
    Private Sub btnUltimo_Click(sender As Object, e As EventArgs) Handles btnUltimo.Click
        Ultimo("respuestas", "cod_respuesta", dtRegistro, "RECLUTAMIENTO")
        MostrarInformacion()
    End Sub
    ...
    Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        Try
            ...
            ElseIf Estilo = "OPCION MULTIPLE" Then
                ...
                For Each it As DataGridViewRow In dgValidas.Rows
                    If Not IsDBNull(it) Then
                        If it.Cells(0).Value Is Nothing Then
                        Else
            ...
            If Agregar Then
                ...
                dtTemporal = sqlExecute("SELECT cod_respuesta FROM respuestas where cod_respuesta = '" & txtCodigo.Text & "'", "RECLUTAMIENTO")
                If dtTemporal.Rows.Count > 0 Then
                ...
                Else 'falta agregar valores de tabla
                    sqlExecute("INSERT INTO respuestas (cod_respuesta,nombre,seleccion_multiple,opciones,estilo) VALUES ('" & txtCodigo.Text & "','" & txtNombre.Text & "','" & Multiple & "','" & Opciones & "','" & Estilo & "')", "RECLUTAMIENTO")
                    Agregar = False
                End If
            ...
            ElseIf Editar Then
                ...
                Cadena = "UPDATE respuestas SET " & _
                ...
                sqlExecute(Cadena, "RECLUTAMIENTO")
            Else
                Agregar = True
                Editar = False
            End If
    ...
    Private Sub btnReporte_Click(sender As Object, e As EventArgs) Handles btnReporte.Click
        ...
        dtCompanias = sqlExecute("SELECT cod_comp FROM cias", "RECLUTAMIENTO")
        frmVistaPrevia.LlamarReporte("respuestas_Rec", dtCompanias)
        frmVistaPrevia.ShowDialog()
    End Sub

    Private Sub btnAnterior_Click(sender As Object, e As EventArgs) Handles btnAnterior.Click
        Anterior("respuestas", "cod_respuesta", txtCodigo.Text, dtRegistro, "RECLUTAMIENTO")
        MostrarInformacion()
    End Sub
