Public Class frmDetalleConsulta
            ...
            If dtConsulta.Rows.Count > 0 Then
                ...
                If dtEmpleado.Rows.Count > 0 Then
                    Try
                        ...
                        txtCia.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("cod_comp")), "N/A", dtEmpleado.Rows(0)("cod_comp")) & "(" & RTrim(IIf(IsDBNull(dtEmpleado.Rows(0)("compania")), "N/A", dtEmpleado.Rows(0)("compania"))) & ")"
                        txtSuper.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("cod_super")), "N/A", dtEmpleado.Rows(0)("cod_super")) & "(" & RTrim(IIf(IsDBNull(dtEmpleado.Rows(0)("nombre_super")), "N/A", dtEmpleado.Rows(0)("nombre_super"))) & ")"
                        txtTurno.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("cod_hora")), "N/A", dtEmpleado.Rows(0)("cod_hora")) & "(" & RTrim(IIf(IsDBNull(dtEmpleado.Rows(0)("nombre_horario")), "N/A", dtEmpleado.Rows(0)("nombre_horario"))) & ")"
                        txtPuesto.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("cod_puesto")), "N/A", dtEmpleado.Rows(0)("cod_puesto")) & "(" & RTrim(IIf(IsDBNull(dtEmpleado.Rows(0)("nombre_puesto")), "N/A", dtEmpleado.Rows(0)("nombre_puesto"))) & ")"
                        txtDepto.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("cod_depto")), "N/A", dtEmpleado.Rows(0)("cod_depto")) & "(" & RTrim(IIf(IsDBNull(dtEmpleado.Rows(0)("nombre_depto")), "N/A", dtEmpleado.Rows(0)("nombre_depto"))) & ")"
                        txtTipoEmp.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("cod_tipo")), "N/A", dtEmpleado.Rows(0)("cod_tipo")) & "(" & RTrim(IIf(IsDBNull(dtEmpleado.Rows(0)("nombre_tipoEmp")), "N/A", dtEmpleado.Rows(0)("nombre_tipoEmp"))) & ")"
                        txtAlta.Value = dtEmpleado.Rows(0)("alta")
                        txtImss.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("imss")), "N/A", dtEmpleado.Rows(0)("imss")) & " - " & RTrim(IIf(IsDBNull(dtEmpleado.Rows(0)("dig_ver")), "N/A", dtEmpleado.Rows(0)("dig_ver")))
                        txtPlanta.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("cod_planta")), "N/A", dtEmpleado.Rows(0)("cod_planta")) & "(" & RTrim(IIf(IsDBNull(dtEmpleado.Rows(0)("nombre_planta")), "N/A", dtEmpleado.Rows(0)("nombre_planta"))) & ")"
                        txtDireccion.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("d_completa")), "N/A", dtEmpleado.Rows(0)("d_completa"))
                        txtEmergencia.Text = IIf(IsDBNull(dtEmpleado.Rows(0)("aviso_acc")), "N/A", dtEmpleado.Rows(0)("aviso_acc"))
                        If valor = True Then
                    ...
                    If (IsDBNull(dtEmpleado.Rows(0)("baja"))) Then
                    ...
                    Else
                        ...
                        txtBaja.Value = dtEmpleado.Rows(0)("baja")
                ...
                sbConsultaFamiliar.Value = dtConsulta.Rows(0)("familiar")
                'panelFamiliar.Visible = sbConsultaFamiliar.Value

                If sbConsultaFamiliar.Value = True Then
                    comboFamiliaresRegistrados.SelectedValue = dtConsulta.Rows(0)("id_familiar")
                End If

                Dim dtFam As DataTable
                dtFam = sqlExecute("select * from familiares where reloj='" & dtConsulta.Rows(0)("reloj") & "'")
                ...
                sbFamiliarRegistrado.Value = dtConsulta.Rows(0)("familiar_registrado")
        ...
        Try
            If sbConsultaFamiliar.Value = True Then
               ...
               "sermed.dbo.grupos_sintomas.nombre as 'sintoma' " & _
                   ...
                   "left join sermed.dbo.grupos_sintomas on sermed.dbo.grupos_sintomas.cod_grupo = sermed.dbo.consultas.sintoma " & _
                   "where sermed.dbo.consultas.reloj = '" & RTrim(txtReloj.Text) & "' and sermed.dbo.consultas.id_familiar = '" & CodFam & "' and sermed.dbo.consultas.familiar = '1' order by fecha desc,hora desc"
    ...
    Private Sub GuardarCambios()
        ...
        Try
            ...
            EditaConsulta(folio, "familiar", IIf(sbConsultaFamiliar.Value, 1, 0))
    ...
    Private Sub btnReporte_Click(sender As Object, e As EventArgs) Handles btnReporte.Click
        ...
        Try
            If sbConsultaFamiliar.Value = True Then
                ...
                frmVistaPrevia.ShowDialog()
            Else
                Dim consulta As String = "select * from consultasvw where reloj = '" & RTrim(txtReloj.Text) & "' and familiar = '0' order by fecha desc,hora desc"
    ...
    Private Sub dgConsultas_CellContentClick(sender As Object, e As DataGridViewCellEventArgs)

    End Sub

    Private Sub dtFecha_Click(sender As Object, e As EventArgs)
    ...
    Private Sub comboFamiliaresRegistrados_TextChanged(sender As Object, e As EventArgs) Handles comboFamiliaresRegistrados.TextChanged
