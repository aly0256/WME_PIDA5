...
#End Region
    ...
    Private Sub frmcod_civil_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            dtLista = sqlExecute("SELECT cod_civil as 'Código',Nombre FROM civil")
            dtLista.DefaultView.Sort = "Código"
            dgTabla.DataSource = dtLista
            dgTabla.Columns(1).AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill

            dtRegistro = sqlExecute("SELECT TOP 1 * FROM civil ORDER BY cod_civil ASC ")
            MostrarInformacion()
    ...
    Private Sub MostrarInformacion()
        ...
        txtCodigo.Text = dtRegistro.Rows(0).Item("cod_civil")
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        Dim Cod As String
        Cod = Buscar("civil", "cod_civil", "estado civil", False)
        If Cod <> "CANCELAR" Then
            dtRegistro = sqlExecute("SELECT * FROM civil WHERE cod_civil = '" & Cod & "' ")
            MostrarInformacion()
        End If
    End Sub

    Private Sub btnPrimero_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrimero.Click
        Primero("civil", "cod_civil", dtRegistro)
        MostrarInformacion()
    End Sub

    Private Sub btnCiasPrev_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAnterior.Click
        Anterior("civil", "cod_civil", txtCodigo.Text, dtRegistro)
        MostrarInformacion()
    End Sub

    Private Sub btnSiguiente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSiguiente.Click
        Siguiente("civil", "cod_civil", txtCodigo.Text, dtRegistro)
        MostrarInformacion()
    End Sub

    Private Sub btnBorrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBorrar.Click
        Codigo = txtCodigo.Text
        dtTemporal = sqlExecute("SELECT reloj from personalvw WHERE cod_civil = '" & Codigo & "'")
        ...
        Else
            If MessageBox.Show("¿Está seguro de borrar el registro " & Codigo & "?", "Borrar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                dtTemporal = sqlExecute("DELETE FROM civil WHERE cod_civil = '" & Codigo & "'")
    ...
    Private Sub btnUltimo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUltimo.Click
        Ultimo("civil", "cod_civil", dtRegistro)
        MostrarInformacion()
    End Sub
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        If Agregar Then
            ' Si Agregar, revisar si existe cod_civil
            dtTemporal = sqlExecute("SELECT cod_civil FROM civil where cod_civil = '" & txtCodigo.Text & "'")
            If dtTemporal.Rows.Count > 0 Then
                ...
                Exit Sub
            Else
                sqlExecute("INSERT INTO civil (cod_civil,nombre) VALUES ('" & txtCodigo.Text & "','" & txtNombre.Text & "')")
                Agregar = False
            End If

        ElseIf Editar Then
            ' Si Editar, entonces guardar cambios a registro
            sqlExecute("UPDATE civil SET nombre = '" & txtNombre.Text & "' WHERE cod_civil = '" & txtCodigo.Text & "'")
        Else
            Agregar = True
        End If
        Editar = False
    ...
    Private Sub btnReporte_Click(sender As Object, e As EventArgs) Handles btnReporte.Click
        frmVistaPrevia.LlamarReporte("EstadoCivil", Nothing)
    ...
    '    dtRegistro = sqlExecute("SELECT * FROM civil WHERE cod_civil = '" & estado & "' ")
    '    MostrarInformacion()
    'End Sub
End Class