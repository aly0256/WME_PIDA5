...
#End Region
    ...
    Private Sub MostrarInformacion()
        ...
        txtCodigo.Text = dtRegistro.Rows(0).Item("cod_super")
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        If Cod <> "CANCELAR" Then
            dtRegistro = sqlExecute("SELECT * from super WHERE cod_super = '" & Cod & "' AND cod_comp = '" & Compania & "'")
            MostrarInformacion()
        End If
    End Sub
    ...
    Private Sub btnCiasPrev_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAnterior.Click
        Anterior("super", "(cod_comp + cod_super)", cmbCia.SelectedValue & txtCodigo.Text, dtRegistro)
        MostrarInformacion()
    End Sub
    ...
    Private Sub btnUltimo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUltimo.Click
        Ultimo("super", "(cod_comp + cod_super)", dtRegistro)
        MostrarInformacion()
    End Sub
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        If Agregar Then
            ...
            For Each row As DataRow In dtCias.Rows
                dtTemporal = sqlExecute("SELECT cod_super FROM super where cod_comp = '" & row("cod_comp") & "' AND cod_super = '" & txtCodigo.Text & "'")
                If dtTemporal.Rows.Count > 0 Then
                    MessageBox.Show("El registro no se puede agregar, ya existe el supervisor '" & txtCodigo.Text & "' asignado a la compañía '" & row("cod_comp") & "'.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    txtCodigo.Focus()
                    Exit Sub
                End If
            Next
            ...
            For Each row As DataRow In dtCias.Rows
                ...
                '*** LA CLERKS ***
                Dim Clerk As String = ""
                sqlExecute("INSERT INTO super (cod_comp,cod_super,nombre,reloj,cod_clerk) VALUES ('" & row("cod_comp") & "','" & txtCodigo.Text & "','" & nompro & "','" & cmbReloj.SelectedValue & "','" & Clerk & "')")
                sqlExecute("UPDATE super SET correo = '" & txtEmail.Text & "' WHERE cod_super = '" & txtCodigo.Text & "' AND cod_comp = '" & row("cod_comp") & "'")
                '*****************
        ...
        ElseIf Editar Then
            ...
            For Each row As DataRow In dtCias.Rows
                ...
                '*** LA CLERKS ***
                Dim Clerk As String = ""
                sqlExecute("UPDATE super SET nombre = '" & txtNombre.Text & "', reloj = '" & cmbReloj.SelectedValue & "',cod_clerk = '" & Clerk & "' WHERE cod_super = '" & txtCodigo.Text & "' AND cod_comp = '" & row("cod_comp") & "'")
                sqlExecute("UPDATE super SET correo = '" & txtEmail.Text & "' WHERE cod_super = '" & txtCodigo.Text & "' AND cod_comp = '" & row("cod_comp") & "'")
                '*****************
            Next
    ...
    Private Sub frmSuper_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            dtLista = sqlExecute("SELECT cod_comp as 'Compañía',cod_super as 'Código',Nombre FROM super")
            ...
            dtRegistro = sqlExecute("SELECT TOP 1 * FROM super ORDER BY cod_comp ASC, cod_super ASC")
            MostrarInformacion()
        Catch ex As Exception
    ...
    Private Sub btnSiguiente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSiguiente.Click
        Siguiente("super", "(cod_comp + cod_super)", cmbCia.SelectedValue & txtCodigo.Text, dtRegistro)
        MostrarInformacion()
    End Sub
    ...
    Private Sub btnBorrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBorrar.Click
        ...
        dtTemporal = sqlExecute("SELECT reloj from personalvw WHERE cod_super = '" & codigo & "' AND cod_comp = '" & comp & "'")
        If dtTemporal.Rows.Count > 0 Then
        ...
        Else
            If MessageBox.Show("¿Está seguro de borrar el registro " & codigo & "?", "Borrar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                sqlExecute("DELETE FROM super WHERE cod_super = '" & codigo & "' AND cod_comp = '" & comp & "'")
    ...
    Private Sub dgTabla_RowEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgTabla.RowEnter
        ...
        dtRegistro = sqlExecute("SELECT * from super WHERE cod_super = '" & cod & "' AND cod_comp = '" & nom & "'")
        MostrarInformacion()
    End Sub
End Class