...
#End Region
    ...
    Private Sub frmcod_remitente_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            dtLista = sqlExecute("SELECT cod_remitente as 'Código',Nombre FROM remitente")
            ...
            dtRegistro = sqlExecute("SELECT TOP 1 * FROM remitente ORDER BY cod_remitente ASC ")
            MostrarInformacion()
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        Dim Cod As String
        Cod = Buscar("remitente", "cod_remitente", "estado remitente", False)
        If Cod <> "CANCELAR" Then
            dtRegistro = sqlExecute("SELECT * FROM remitente WHERE cod_remitente = '" & Cod & "' ")
            MostrarInformacion()
        End If
    End Sub

    Private Sub btnPrimero_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrimero.Click
        Primero("remitente", "cod_remitente", dtRegistro)
        MostrarInformacion()
    End Sub

    Private Sub btnCiasPrev_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAnterior.Click
        Anterior("remitente", "cod_remitente", txtCodigo.Text, dtRegistro)
        MostrarInformacion()
    End Sub

    Private Sub btnSiguiente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSiguiente.Click
        Siguiente("remitente", "cod_remitente", txtCodigo.Text, dtRegistro)
        MostrarInformacion()
    End Sub
    ...
    Private Sub btnBorrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBorrar.Click
        ...
        If MessageBox.Show("¿Está seguro de borrar el registro " & Codigo & "?", "Borrar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            sqlExecute("DELETE FROM remitente WHERE cod_remitente = '" & Codigo & "'")
    ...
    Private Sub dgTabla_RowEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgTabla.RowEnter
        ...
        dtRegistro = sqlExecute("SELECT * FROM remitente WHERE cod_remitente = '" & cod & "' AND nombre = '" & nom & "'")
        MostrarInformacion()
    End Sub
    ...
    Private Sub btnUltimo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUltimo.Click
        Ultimo("remitente", "cod_remitente", dtRegistro)
        MostrarInformacion()
    End Sub
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        Try
            ...
            If Agregar Then
                ' Si Agregar, revisar si existe cod_remitente
                dtTemporal = sqlExecute("SELECT cod_remitente FROM remitente where cod_remitente = '" & txtCodigo.Text & "'")
                If dtTemporal.Rows.Count > 0 Then
                    ...
                    Exit Sub
                Else
                    sqlExecute("INSERT INTO remitente (cod_remitente,nombre,cod_comp,cod_puesto) VALUES ('" & txtCodigo.Text & "','" & txtNombre.Text & "','" & cmbCia.SelectedValue & "','" & cmbPuesto.SelectedValue & "')")
                    Agregar = False
                End If

            ElseIf Editar Then
                ' Si Editar, entonces guardar cambios a registro
                sqlExecute("UPDATE remitente SET nombre = '" & txtNombre.Text & "',cod_puesto = '" & cmbPuesto.SelectedValue & "',cod_comp = '" & cmbCia.SelectedValue & "' WHERE cod_remitente = '" & txtCodigo.Text & "'")
            Else
                Agregar = True
            End If
            Editar = False
    ...
    Private Sub btnReporte_Click(sender As Object, e As EventArgs) Handles btnReporte.Click
        frmVistaPrevia.LlamarReporte("Estadoremitente", Nothing)
        frmVistaPrevia.ShowDialog()
    End Sub

    Private Sub cmbCia_SelectionChanged(sender As Object, e As DevComponents.AdvTree.AdvTreeNodeEventArgs) Handles cmbCia.SelectionChanged
        Try
            dtPuestos = sqlExecute("SELECT cod_puesto,nombre FROM puestos WHERE cod_comp = '" & cmbCia.SelectedValue & "'")
            cmbPuesto.DataSource = dtPuestos
            cmbPuesto.ValueMember = "cod_puesto"
            cmbPuesto.DisplayMembers = "cod_puesto,nombre"
            cmbPuesto.Columns(0).Width.Absolute = 50
        Catch ex As Exception
                        ErrorLog(Usuario, System.Reflection.MethodBase.GetCurrentMethod.Name(), Me.Name, ex.HResult, ex.Message)
        End Try
    End Sub

    Private Sub cmbCia_TextChanged(sender As Object, e As EventArgs) Handles cmbCia.SelectedValueChanged
