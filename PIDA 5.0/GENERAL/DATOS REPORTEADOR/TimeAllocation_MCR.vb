    ...
    Public Sub DistribucionHorasAusentismo(ByRef dtDatos As DataTable, ByVal dtInformacion As DataTable)
        Try
            ...
            dtDistribucion = sqlExecute("SELECT DatosTA.*,ALTA_ANT,BAJA_ANT,CENTRO_COSTOS FROM (" & _
                                        ...
                                        "ON REINGRESOS.RELOJ = DatosTA.RELOJ " & _
                                        "WHERE REINGRESOS.RELOJ IS NULL OR " & _
                                            "   (reingresos.alta_ant BETWEEN '" & FechaSQL(FechaInicio) & "' and '" & FechaSQL(FechaFin) & _
                                            "' or reingresos.baja_ant BETWEEN '" & FechaSQL(FechaInicio) & "' and '" & FechaSQL(FechaFin) & "') " & _
                                        "order by reloj,fecha", "TA")
            ...
            dtDatos.Columns.Add("horas_parciales", Type.GetType("System.Double"))
            ...
            dtDistAusentismo.PrimaryKey = New DataColumn() {dtDistAusentismo.Columns("tipo_aus")}
            ...
            For Each dEmp In dtDistribucion.Select("", "reloj,fecha")
                ...
                If Not IsDBNull(dEmp("ausentismo")) And Activo Then
                    ...
                    If IIf(IsDBNull(dEmp("goce_sdo")), 0, dEmp("goce_sdo")) = 0 Then
                        ...
                        dDistAus = dtDistAusentismo.Rows.Find(IIf(IsDBNull(dEmp("nombre_aus")), "NO IDENTIFICADO", dEmp("nombre_aus")).ToString.Trim)
                    ...
                    End If
                Else
                    If Habil And Horas - (Normales * Factor) > 0 Then
                        ...
                        drResumen("horas_parciales") += Math.Round(Horas - (Normales * Factor), 4)
                    End If
                End If
                If Habil Then
