...
Public Class frmReporteadorHerramientas
    ...
    Private Function OrdenAcumulado() As String
        ...
        Return FL
    End Function
    Private Sub frmReporteadorHerramientas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            cmbTipoReportes.DataSource = sqlExecute("SELECT tipo,nombre FROM tipo_reportes where TIPO='H' ", "HERRAMIENTAS")
            cmbTipoReportes.SelectedValue = "H"
    ...
    Private Sub btnGenerar_Click(sender As Object, e As EventArgs) Handles btnGenerar.Click
        ...
        Try
            ...
            'Ambito = IIf(Tipo = "N" Or Tipo = "F", "UniformesEmpleadosVW", "ArticulosEmpleadosVW")
            'Ambito2 = IIf(Tipo = "N" Or Tipo = "F", "UNIFORME", "ARTICULO")
    ...
    Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        Try
            ...
            dtDisponibles = sqlExecute("SELECT UPPER(COD_CAMPO) AS 'campo',personal.dbo.IniciaMayuscula(NOMBRE) AS 'nombre' FROM campos WHERE TABLA IS NULL  OR TABLA = '" & Ambito & "' ORDER BY nombre", "HERRAMIENTAS")
            ReporteadorFuente = "HERRAMIENTAS"
    ...
    Private Sub cmbTipoReportes_TextChanged(sender As Object, e As EventArgs) Handles cmbTipoReportes.TextChanged
        'Ambito = IIf(cmbTipoReportes.SelectedValue.Equals("N") Or cmbTipoReportes.SelectedValue.Equals("F"), "UniformesEmpleadosVW", "ArticulosEmpleadosVW")
        'Ambito2 = IIf(cmbTipoReportes.SelectedValue.Equals("N") Or cmbTipoReportes.SelectedValue.Equals("F"), "UNIFORME", "ARTICULO")
        Ambito = "UniformesEmpleadosVW"
        Ambito2 = "UNIFORME"
        chkTodos.Checked = True
        dtResultado = sqlExecute("SELECT " & IIf(Ambito.Equals("UniformesEmpleadosVW"), "COD_UNIF", "COD_ART") & " as 'Código'," & Ambito2 & "  AS 'Producto'," & Ambito & ".* FROM " & Ambito & "", "HERRAMIENTAS")
        CargarReportes()
    ...
    Private Sub frmReporteadorHerramientas_Resize(sender As Object, e As EventArgs) Handles Me.Resize
