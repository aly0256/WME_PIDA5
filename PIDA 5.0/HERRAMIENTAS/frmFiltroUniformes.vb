Public Class frmFiltroUniformes
    ...
    Dim Ambito As String = frmReporteadorUniformes.AmbitoUniformes
    ...
    Private Sub frmFiltroUniformes_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        Me.Dispose()
        Me.Close()
    End Sub
