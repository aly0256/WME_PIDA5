Public Class frmOrdenH
    ...
    Private Sub frmOrden_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dtCampos = sqlExecute("SELECT nombre AS 'NOMBRE',UPPER(cod_campo) as 'COD_CAMPO' FROM campos WHERE TABLA IS NULL OR TABLA = '" & Ambito & "' ORDER BY nombre", "HERRAMIENTAS")
...
ErrS:
    ...
    Private Sub frmOrdenH_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        Me.Dispose()
        Me.Close()
    End Sub
End Class